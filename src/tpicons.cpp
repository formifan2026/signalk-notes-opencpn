...
//    fn.AppendDir(wxT("signalk_notes_opencpn_pi"));
//#else
//    fn.SetPath(*GetpSharedDataLocation());
    //const char *sPluginName = "signalk_notes_opencpn_pi";
...
wxBitmap tpicons::LoadSVG( const wxString filename, unsigned int width, unsigned int height )
{
    ...
    wxString s = _("signalk_notes_opencpn_pi LoadSVG");
...
bool tpicons::ScaleIcons()
{
    ...
    //m_bm_signalk_notes_opencpn_pi = ScaleIcon( m_p_svgd_signalk_notes_opencpn_pi, m_p_img_signalk_notes_opencpn_pi, m_dScaleFactor );
    //m_bm_signalk_notes_opencpn_grey_pi = ScaleIcon( m_p_svgd_signalk_notes_opencpn_grey_pi, m_p_img_signalk_notes_opencpn_grey_pi, m_dScaleFactor );
...
void tpicons::ChangeScheme(void)
{
    switch(m_ColourScheme) {
        ...
        case PI_GLOBAL_COLOR_SCHEME_DAY:
            m_bm_signalk_notes_opencpn_grey_pi = m_bm_day_signalk_notes_opencpn_grey_pi;
            break;
        case PI_GLOBAL_COLOR_SCHEME_DUSK:
            m_bm_signalk_notes_opencpn_grey_pi = m_bm_dusk_signalk_notes_opencpn_grey_pi;
            break;
        case PI_GLOBAL_COLOR_SCHEME_NIGHT:
            m_bm_signalk_notes_opencpn_grey_pi = m_bm_night_signalk_notes_opencpn_grey_pi;
            break;
        default:
            break;
    }
...
void tpicons::CreateSchemeIcons()
{
    ...
    m_bm_day_signalk_notes_opencpn_toggled_pi = m_bm_signalk_notes_opencpn_toggled_pi;
    m_bm_day_signalk_notes_opencpn_pi = m_bm_signalk_notes_opencpn_pi;
    m_bm_dusk_signalk_notes_opencpn_grey_pi = BuildDimmedToolBitmap(m_bm_signalk_notes_opencpn_grey_pi, 128);
    m_bm_dusk_signalk_notes_opencpn_pi = BuildDimmedToolBitmap(m_bm_signalk_notes_opencpn_pi, 128);
    m_bm_dusk_signalk_notes_opencpn_toggled_pi = BuildDimmedToolBitmap(m_bm_signalk_notes_opencpn_toggled_pi, 128);
    m_bm_night_signalk_notes_opencpn_grey_pi = BuildDimmedToolBitmap(m_bm_signalk_notes_opencpn_grey_pi, 32);
    m_bm_night_signalk_notes_opencpn_pi = BuildDimmedToolBitmap(m_bm_signalk_notes_opencpn_pi, 32);
    m_bm_night_signalk_notes_opencpn_toggled_pi = BuildDimmedToolBitmap(m_bm_signalk_notes_opencpn_toggled_pi, 32);
