/******************************************************************************
 * $Id: signalk_notes_opencpn_pi.h,v 1.0 2015/01/28 01:54:37 jongough Exp $
 *
 * Project:  OpenCPN
 ...
 ***************************************************************************
 */
#ifndef _SIGNALK_NOTES_OPENCPNPI_H_
#define _SIGNALK_NOTES_OPENCPNPI_H_
...
//    wxGLCanvas      *m_glcc;
    ...
    int     m_iCallerId;
    bool    m_btpDialog;
    int     m_signalk_notes_opencpn_button_id;
